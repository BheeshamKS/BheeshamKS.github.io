...
const Skills = () => {
  const skillCategories = [
    ...
    {
      title: "Frontend",
      skills: ["React.js", "Three.js", "Tailwind CSS", "HTML5", "CSS3", "Vite"],
    },
    {
      title: "Backend",
      skills: ["Flask", "FastAPI", "Express.js", "Node.js"],
    },
    {
      title: "Databases",
  ...
  return (
    <section
      id="skills"
      className="py-24 px-4 relative z-10 bg-gradient-to-b from-transparent to-[var(--color-surface)]"
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {skillCategories.map((category, idx) => (
            <div
              key={idx}
              className="glass p-8 rounded-3xl border border-[var(--color-border)] shadow-xl relative overflow-hidden"
            >
              {/* Subtle accent glow */}
              ...
              <h3 className="text-xl font-semibold mb-6 text-white border-b border-[var(--color-border)] pb-3">
                {category.title}
              </h3>

...
const About = () => {
  ...
  return (
    <div className="relative z-10 w-full flex flex-col gap-12 pt-24 pb-12">
      {/* --- About Me Section --- */}
      <section id="about" className="px-4 scroll-mt-24">
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div 
            className="glass p-8 md:p-12 text-lg text-gray-300 leading-relaxed rounded-3xl border border-[var(--color-border)] shadow-2xl relative overflow-hidden"
      ...
      {/* --- Education Section --- */}
      <section id="education" className="px-4 scroll-mt-24 pt-12">
        <div className="max-w-5xl mx-auto">
          <motion.div 
            className="text-center mb-12"
            initial={{ opacity: 0, y: 20 }}
          ...
          <motion.div 
            className="max-w-3xl mx-auto glass glass-hover p-8 md:p-10 rounded-3xl flex flex-col transition-all duration-300 relative overflow-hidden group"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
      ...
      {/* --- Awards Section --- */}
      <section id="awards" className="px-4 scroll-mt-24 pt-12">
        <div className="max-w-5xl mx-auto">
          <motion.div 
            className="text-center mb-12"
            initial={{ opacity: 0, y: 20 }}
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4 text-white">Awards & Certifications</h2>
            <div className="w-20 h-1 bg-gradient-to-r from-[var(--color-accent)] to-transparent mx-auto rounded-full"></div>
          </motion.div>
